...
public interface IWorkdayService
{
    ...
    Task<List<WorkdayResponse>> GetWorkdaysAsync(DateTime startDate, DateTime endDate);
    Task<List<WorkdayResponse>> GetWorkdaysAsync();
    Task<WorkdayResponse?> GetWorkdayByIdAsync(Guid workdayId);
